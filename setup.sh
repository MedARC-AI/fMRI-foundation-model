...
pip install numpy matplotlib jupyter jupyter_contrib_nbextensions jupyterlab_nvdashboard jupyterlab scipy ipykernel tqdm scikit-learn scikit-image webdataset pandas matplotlib einops ftfy regex h5py    torchmetrics wandb nilearn nibabel boto3 open_clip_torch kornia huggingface_hub pytorch_lightning packaging
